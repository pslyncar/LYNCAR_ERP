...
class _MasterPlansScreenState extends State<MasterPlansScreen> {
  ...
  final _plansVerticalController = ScrollController();
  final _segmentsVerticalController = ScrollController();
  int _tabIndex = 0;
  bool _loading = true;
  String? _error;
  ...
  @override
  void dispose() {
    _plansVerticalController.dispose();
    _segmentsVerticalController.dispose();
    super.dispose();
  }
          ...
          children: [
            ...
            Expanded(
              child: _loading
                  ...
                  : TabBarView(
                      children: [
                        _scrollableTableCard(
                          controller: _plansVerticalController,
                          child: _plansTable(),
                        ),
                        _scrollableTableCard(
                          controller: _segmentsVerticalController,
                          child: _segmentsTable(),
                        ),
                      ],
                    ),
            ),
