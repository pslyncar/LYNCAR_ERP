...
from app.models import access_control, cash_closing, client, equipment, equipment_status, fiscal, fiscal_assistant, monitoring, payable, pdv_cash_session, pdv_operator, pdv_sync_event, pdv_terminal, product, product_barcode, product_batch, product_composition, production_order, receivable, receiving_scan, receiving_session, sale, service_contract, service_order, stock_entry, stock_entry_audit, stock_movement, supplier, supplier_product_link, ticket, user, xml_inbox  # noqa: F401
