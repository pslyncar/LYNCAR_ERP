...
PERMISSIONS = [
    ...
    PermissionDefinition("sales:view", "Ver historico de vendas", "sales", "Visualizar listagem e historico comercial."),
    PermissionDefinition("sales:manual", "Criar venda manual", "sales", "Criar venda administrativa fora do PDV."),
    PermissionDefinition("sales:create", "Operar PDV Web", "pdv", "Abrir o PDV Web, registrar vendas no caixa e receber pagamentos."),
    ...
    PermissionDefinition("service_orders:attend", "Atender OS", "service_orders", "Assumir atendimento tecnico e movimentar OS em atendimento."),
    PermissionDefinition("service_orders:sell", "Gerar venda da OS", "service_orders", "Transformar OS pronta em venda."),
